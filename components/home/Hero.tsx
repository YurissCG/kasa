    ...
    <section className="relative overflow-hidden bg-ivory pt-16 pb-16 sm:pt-24 sm:pb-24">
      ...
      <div className="relative mx-auto grid max-w-6xl gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:items-center lg:gap-16">
        <div className="mx-auto max-w-xl text-center lg:mx-0 lg:text-left">
          ...
          <p className="mx-auto mt-5 max-w-md text-base text-charcoal-soft lg:mx-0">
        ...
        <Image
          ...
          className="mx-auto aspect-square w-full max-w-md rounded-2xl border border-stone-dark object-cover shadow-[0_16px_44px_rgba(38,35,29,0.14)] lg:max-w-none"
        />
      </div>
